...
// Clase para manejar operaciones de trabajos
class JobController {
    ...
    async createJob(job: any) {
        ...
        const query = `INSERT INTO jobs (id, company_id, job_title, description, location, experience_required, skills_required, education_required, salary_range, created_at) 
