    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 flex items-center justify-center py-12 px-6">
      <div className="bg-gray-800 p-10 rounded-2xl shadow-2xl w-full sm:w-3/4 lg:w-2/3 text-white">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-300">¿Qué son las cookies?</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-300">¿Por qué usamos cookies?</h2>
          <p className="text-gray-400 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-300">Tipos de cookies que utilizamos</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-300">¿Cómo controlar las cookies?</h2>
          <p className="text-gray-400 mt-2">
