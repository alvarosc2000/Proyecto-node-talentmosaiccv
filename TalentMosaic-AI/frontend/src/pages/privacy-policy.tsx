    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 flex items-center justify-center">
      <div className="bg-white p-10 rounded-xl shadow-xl w-full sm:w-3/4 lg:w-2/3 text-gray-900">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Introducción</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Información que recopilamos</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Cómo utilizamos tu información</h2>
          <p className="text-gray-600 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Protección de tu información</h2>
          <p className="text-gray-600 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Tus derechos</h2>
          <p className="text-gray-600 mt-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-indigo-500">Compartir tu información</h2>
          <p className="text-gray-600 mt-2">
